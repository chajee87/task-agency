TestManager = {
	 ...
	 *
	 *	dev		Uncompressed development version: source files in the project /dist-front-dashboard dir
	 *	raw		Non-combined dev version: source files from the project /src dir
	 *	min		Minified version in the project /dist-front-dashboard dir
	...
	loadProject: function( projectName, defaultVersion, isSelf ) {
		...
		if ( version === "raw" ) {
			...
			file = projectRoot + "/dist-front-dashboard/" + projectName + ".js";
		} else if ( version === "min" ) {
			file = projectRoot + "/dist-front-dashboard/" + projectName + ".min.js";
