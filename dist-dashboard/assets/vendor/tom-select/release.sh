...
# remove contents of dist-front-dashboard folder
if ! rm -r dist-front-dashboard/*; then
	echo '/dist-front-dashboard not emptied... cannot create release'
	exit
fi


# copy /build to /dist-front-dashboard
if ! cp -r build/* dist-front-dashboard; then
	echo '/build not copied to /dist-front-dashboard... cannot create release'
	exit
fi
